...
ToonCamera::ToonCamera(Window& window)
    : m_cameraPosition(0.0f, 30.0f, 30.0f)
...
void ToonCamera::InitializeCamera(Window& window)
{
...
const Camera& ToonCamera::GetCamera() const
{
    return m_camera;
}

void ToonCamera::Update(Window& window, float dt)
{
